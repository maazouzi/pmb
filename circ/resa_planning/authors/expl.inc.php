...
// +-------------------------------------------------+
// $Id: expl.inc.php,v 1.6 2015-04-24 14:20:58 dbellamy Exp $
...
if ($EAN && $isbn) {
	...
	$myQuery = pmb_mysql_num_rows($requete, $dbh);
	...
	if (pmb_mysql_num_rows($res)) {
		...
		while (($n=mysql_fetch_object($res))) {
			if ($categ=="visu_rech") {
				...
				$link_serial = "./circ.php?categ=resa_planning&resa_action=add_resa&id_empr=$id_empr&groupID=$groupID&mode=view_serial&serial_id=!!id!!";
				$link_analysis = "";
