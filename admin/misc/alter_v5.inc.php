	...
	case "v5.14":
		...
		case "v5.16":
			...
			$rqt = "create table if not exists authperso_authorities (
				...
				authperso_infos_global text not null default '',
				authperso_index_infos_global text not null default '',
		...
		case "v5.18":
			...
			$rqt = "ALTER TABLE docwatch_watches ADD watch_desc text NOT NULL default ''" ;
